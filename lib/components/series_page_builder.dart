...
class SeriesPageBuilder extends ConsumerStatefulWidget {
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _SeriesPageBuilderState();
}

class _SeriesPageBuilderState extends ConsumerState<SeriesPageBuilder>
    with TickerProviderStateMixin {
  late final AnimationController _heartController;
  late final SharedPreferences prefs;
  int heartId = 0;
  final PagingController<int, SeriesResult> _pagingController =
  ...
  Widget build(BuildContext context) {
    ...
    return DynamicColorBuilder(
      builder: (lightDynamic, darkDynamic) {
        return PagedGridView<int, SeriesResult>(
